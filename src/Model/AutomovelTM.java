...
public class AutomovelTM extends AbstractTableModel {

    private List<String[]> linhas;
    private String[] colunas = new String[]{"Modelo", "Ano", "Placa"};
    
    public AutomovelTM() {
        linhas = new ArrayList<String[]>();
    }
    
    public AutomovelTM(List<String[]> lista) {
    ...
    public String[] getAutomovel(int indiceLinha) {
        return linhas.get(indiceLinha);
    }
    
    public void addAutomovel(String a[]) {
        // Adiciona o registro.
        linhas.add(a);
